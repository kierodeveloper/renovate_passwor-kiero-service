            ...
            <div>
              ...
              <tbody>
                <tr>
                  ...
                  <a href="http://kiero.co/forget?-${token}-" style="font-family:helvetica neue,helvetica,arial,sans-serif;font-weight:bold;font-size:18px;line-height:1.5;color:#ffffff;text-decoration:none;display:block;text-align:center;max-width:400px;overflow:hidden;text-overflow:ellipsis" target="_blank" data-saferedirecturl="">
                  Cambiar Contraseña
                  </a>
                  </tbody></table>
                  </a>
